...
const AppScreen: React.VFC<Props> = ({ children, safeAreaViewBackgroundColor, additionalStyles }) => (
    //Known issue: SafeAreaView currently only applicable to iOS devices with iOS version 11 or later
    <SafeAreaView style={[styles.safeAreaView, {backgroundColor: safeAreaViewBackgroundColor}]}>
        <View style={[styles.contentContainer, additionalStyles]}>
        {children}
        </View>
    </SafeAreaView>   
)
